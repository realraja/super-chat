export const config = {
  ...
  DATABASE_NAME: process.env.DATABASE_NAME || "chat-service",
  COOKIE_EXPIRE_DAY: Number(process.env.COOKIE_EXPIRE_DAY || 7),
  JWT_ACCESS_SECRET: process.env.JWT_ACCESS_SECRET || "0f8bf908f8d38527c188c93bda49d48bd421a43fa0bdf3e77de1f0db785e6f37",
  JWT_ACCESS_SECRET_EXPIRY: process.env.JWT_ACCESS_SECRET_EXPIRY || "7d",
  ALLOWED_ORIGINS: process.env.ALLOWED_ORIGINS,
  ADMIN_SECRET_PASS: process.env.ADMIN_SECRET_PASS || "supersecretpassword",
